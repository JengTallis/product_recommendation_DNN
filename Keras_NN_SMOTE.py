...
#Using SMOTE
print('Original dataset shape {}'.format(Counter(label)))  #Original count of +ve and -ve labels
sm = SMOTE(random_state = 42)
label = np.ravel(label)
X, Y = sm.fit_sample(data, label)                          #sampling from existing data
print('Resampled dataset shape {}'.format(Counter(Y)))     #Final count of +ve and -ve labels
