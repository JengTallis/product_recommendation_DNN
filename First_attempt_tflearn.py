...
#Data loading and assigning input columns and labels
...
#Splitting dataset as tarining, cross validation and test set in ratio 6:1:3 
...
#Data preprocessing such that mean is 0 and std 1
...
layer2 = tflearn.fully_connected(layer1, 48, activation = 'relu', regularizer = 'L2', weight_decay = 0.001, weights_init = 'xavier')
layer2 = tflearn.dropout(layer2, 0.6)
layer3 = tflearn.fully_connected(layer2, 24, activation = 'relu', regularizer = 'L2', weight_decay = 0.001, weights_init = 'xavier')
softmax = tflearn.fully_connected(layer3, 24, activation = 'softmax')

# Regression using Adam optimizer, Accuracy as evaluation metric
adam = tflearn.Adam(learning_rate = 0.1, beta1 = 0.9, beta2 = 0.999)
acc = tflearn.metrics.Accuracy()
network = tflearn.regression(softmax, optimizer = adam, metric = acc, loss = 'categorical_crossentropy')
