...
#Data loading (Using all input features to make predictions for 1 product)
...
label = csvfile[['label_7']]
 
#Split dataset into training and test data in ratio 7:3
...
# Compile model, use Adam Optmizer
